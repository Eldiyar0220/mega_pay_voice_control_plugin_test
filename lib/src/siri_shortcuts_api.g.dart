...
class SiriShortcutsApi {
  ...
  Future<CreateShortcutResult> createShortcut(ShortcutOptions arg_options) async {
    final BasicMessageChannel<Object?> channel = BasicMessageChannel<Object?>(
        'dev.flutter.pigeon.SiriShortcutsApi.createShortcut', codec,
...
abstract class SiriShortcutsFlutterApi {
  ...
  static void setup(SiriShortcutsFlutterApi? api, {BinaryMessenger? binaryMessenger}) {
    {
      final BasicMessageChannel<Object?> channel = BasicMessageChannel<Object?>(
          'dev.flutter.pigeon.SiriShortcutsFlutterApi.onShortcutTriggered', codec,
      ...
      if (api == null) {
        ...
        channel.setMessageHandler((Object? message) async {
          assert(message != null,
          'Argument for dev.flutter.pigeon.SiriShortcutsFlutterApi.onShortcutTriggered was null.');
